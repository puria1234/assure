    ...
    <html>
      ...
      <body style={{ background:'#0a0a0a', color:'#fff', fontFamily:'Inter, sans-serif', margin:0 }}>
        ...
        <main style={{ maxWidth:'760px', margin:'0 auto', padding:'80px 24px' }}>
          ...
          <p style={pStyle}>By accessing or using Assure, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.</p>

          <h2 style={h2Style}>2. Description of Service</h2>
          <p style={pStyle}>Assure is a platform that helps you track product warranties, get expiry alerts, scan receipts with AI, and get AI assisted help filing warranty claims. It's a convenience tool only, not legal advice, an insurance product, or a guarantee that any given claim will succeed.</p>
          ...
          <p style={pStyle}>Assure is provided "as is" without warranties of any kind. We are not liable for any damages arising from your use of the service, and our total liability is capped at whichever is greater: what you paid us in the past 12 months, or $50.</p>
