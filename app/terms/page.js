    ...
    <html>
      ...
      <body style={{ background:'#0a0a0a', color:'#fff', fontFamily:'Inter, sans-serif', margin:0 }}>
        ...
        <main style={{ maxWidth:'760px', margin:'0 auto', padding:'80px 24px' }}>
          ...
          <p style={pStyle}>Keep your account info accurate and your login secure. You're responsible for what happens under your account, so let us know if you spot any unauthorized use; we can also refuse or terminate accounts at our discretion.</p>

          <h2 style={h2Style}>4. Subscriptions and Billing</h2>
          <p style={pStyle}>Paid plans run through Paddle, our payment processor, and renew automatically unless you cancel. Every plan starts with a 14 day free trial, and your first charge is covered by a 7 day money back guarantee; you can cancel anytime right in the app.</p>
          ...
          <p style={pStyle}>Basically, don't misuse Aegis. That means no illegal activity, hacking, reverse engineering, malware, scraping, or impersonation, and don't use the AI features to generate harmful content. Breaking this can get your account suspended or shut down.</p>

          <h2 style={h2Style}>6. AI Features: Disclaimer and Limitations</h2>
          <p style={pStyle}>AI receipt scanning and the claim assistant are here to help, but AI can get things wrong. Nothing they produce is legal, financial, or professional advice, so double check before you rely on it, and a successful claim is never guaranteed.</p>
